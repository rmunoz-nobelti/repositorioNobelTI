...
declare namespace ns2="http://cl.gtd.com/schemas/crearEmpleadoResponse";
(:: import schema at "../XSD/crearEmpleadoExpResponse.xsd" ::)

declare variable $estadoOperacion as element() (:: schema-element(ns1:estadoOperacion) ::) external;

declare function local:func($estadoOperacion as element() (:: schema-element(ns1:estadoOperacion) ::)) as element() (:: schema-element(ns2:crearEmpleadoResponse) ::) {
    <ns2:crearEmpleadoResponse>
        <ns2:estadoOperacion>
